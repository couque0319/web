...
이 프로젝트는 여러 웹 서비스 개발 경험을 기반으로 한 종합 웹 개발 프로젝트로, 다양한 기능 구현 및 UI/UX 실험을 통해 웹 기술을 실제 서비스 형태로 구현하는 것을 목표로 합니다.
...
Supabase를 사용해 테이블 데이터를 불러오고 React에서 비동기로 처리합니다.
...
1. 다양한 웹 서비스 개발을 병행하며 기술역량 확장
2. GitHub 기반 버전 관리
3. Supabase, Public Data API, KakaoMap, vWorld API 연동 실습
4. Canvas/Phaser 기반 게임 개발 실습
5. PPT, Markdown 정리로 문서화 능력 강화
...
- **APIs:** 공공데이터포털, KakaoMap, vWorld
- **Game Engine:** Phaser, Canvas API
...
- 실무형 웹 개발 프로젝트 경험 축적
- API 연동 및 데이터 처리 능력 향상
- 지도 기반 서비스 개발 경험
- 게임 개발 로직 및 인터랙션 구현
- 협업 도구 활용 및 문서화 능력 강화
